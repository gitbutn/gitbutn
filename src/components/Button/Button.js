...
class Button extends Component {
  constructor(props) {
    ...
    this.state = {
      colorPack: ['#000000','#525252','#767676','#868686','#969696','#d9d9d9','#f1f1f1'],
      showPicker1: false,
      showPicker2: false,
    ...
    return (
        ...
        <div className='slider-picker-style'>
          <div className='slider-conter'>
            <SliderPicker onChange={e => this.setIconBgColor(e)} color={this.state.iconbgcolor}/>
          </div>
          <TwitterPicker colors={this.state.colorPack} triangle='hide' onChange={e => this.setIconBgColor(e)} color={this.state.iconbgcolor}/>        
        </div>
        <Arrow width='30' className='arrow-top-left' fill={'#ccc'}/>
          ...
          <div className='btn-container'>
            <div className='iconbg' onClick={this.showColorPicker1.bind(this)} style={{backgroundColor: this.state.iconbgcolor}}>
              <Icons icon={this.state.iconSearchStick} width='120' height='120' fill={this.state.iconColor} logofill={this.state.iconColor}/>            
            </div>
            <div className='txtbg' style={{backgroundColor: this.state.txtBgColor }} onClick={this.showColorPicker1.bind(this)}>
              <h3 style={{ color: this.state.titleColor }}>{this.state.title || 'Button Title'}</h3>
              <p style={{ color: this.state.subtitleColor }}>{this.state.subtitle || 'SubTitle'}</p>
            </div>
          </div>
        ...
        { this.state.showPicker1 &&
          ...
          <div className='slider-picker-style'>
            <div className='slider-conter'>
              <SliderPicker onChange={e => this.setTextBgColor(e)} color={this.state.txtBgColor}/>
            </div>
            <TwitterPicker colors={this.state.colorPack} triangle='hide' onChange={e => this.setTextBgColor(e)} color={this.state.txtBgColor} />        
          </div>
          </div>
        }
        </div>
        ...
        <div className='icon-left-container'>
            ...
            <Arrow width='30' height='30' fill='#ccc' className='icon-arrow-top'/>
            <div className='icon-input-holder'>
            <div className='subtext-input'>
              <div className='colorValue'></div>

              <input type='text' ref={s => this.iconsearchtxt = s} 
              ...
              style={{display: this.state.subtitle.length >= 3 ? '' : ''}}
         ...
         { this.state.showPicker1 && 
        <div className='color-picker-text' style={{display: this.state.showPicker1 ? 'block' : 'block'}}>
        <Arrow width='30' className='arrow' fill={'#ccc'}/>
        <div className='txt-div-container'>

          {/* inputs color and picker */}
          <div className='inputs-holder-text' style={{backgroundColor: '#ccc'}}>
            <div className='text-input-container'>
              <div className='text-input'>
                <div className='colorValue' onClick={() => this.showTitleColorPicker()} style={{backgroundColor: this.state.titleColor}} onClick={this.showTitleColorPicker.bind(this)}></div>
                ...
                onChange={e => this.onChangeTitle(e)}/>
                  ...
                  style={{display: this.state.title.length >= 3 ? '' : ''}}
                  />
            ...
            <div className='subtext-input'>
              <div className='colorValue' style={{backgroundColor: this.state.subtitleColor}}></div>

              <input type='text' ref={s => this.subtitle = s} 
          ...
          <div className='colors-packger' style={{backgroundColor: '#ccc'}}>
            <div style={{marginBottom: '5px'}}>
            <TwitterPicker
            ...
            <button className='quqEwa' onClick={() => this.quoqAll()}>Click</button>
        </div>
